...
g.fig.suptitle("Sobol' total index by QoI", fontweight="bold",x=0.85,y=0.25,fontsize=13)
...
g.savefig(f"2_{filename_prefix}_multi_bars_sobol.png", dpi=600)
