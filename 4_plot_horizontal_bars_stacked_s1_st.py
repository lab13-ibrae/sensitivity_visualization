...
ax.set_xlim([0, 1])
#order of parameters from the bottom to the top
ax.invert_yaxis()
...
#plot title
plt.title(f"QoI: {qoi}. Sobol' indices", y=1, fontweight="bold")

#adjust the padding
plt.tight_layout()

#save figure with desired name, format, dpi. f'{<variable_name>}' for filename customization using previously defined variables
plt.savefig(f'4_{filename_prefix}_{qoi}_horiz_bars_sobol.png', dpi=600)
