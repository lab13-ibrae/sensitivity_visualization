...
ax.hlines(y = 1, xmin = 1000, xmax = 1000000, color = 'gray', linestyles='dashed',linewidth = 1, label='whole variance')
...
fig.savefig(fname=f"13_{filename_prefix}_stacked.png", dpi=600)